...
sudo parted $LOOP mkpart primary ext4 4257MiB 8001Mi# # OS2 (3.7GB)
sudo parted $LOOP mkpart primary ext4 8001MiB 100%    # DATA (remaining)
...
echo "cleanup..."
# Unmount everything
sudo umount $BOOT_MNT $OS1_MNT $OS2_MNT $DATA_MNT
sudo rmdir $BOOT_MNT $OS1_MNT $OS2_MNT $DATA_MNT
sudo losetup -d $LOOP
